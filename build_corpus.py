...
def main():
    ...
    parser.add_argument('--in_path', '-i', type=str, default='chembl24.csv', help='input file')
    parser.add_argument('--out_path', '-o', type=str, default='chembl24_corpus.txt', help='output file')
